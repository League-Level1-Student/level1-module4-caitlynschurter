...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "Hi. Here's a hint: \n there is no hint! yay!");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		int secretLocationX = 224;
		int secretLocationY = 31;
		/**
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			JOptionPane.showInputDialog("...ask a question... i mean... if you want...");
